...
export const act2Slides: SlideData[] = [
  /* ── Slide 8: Carrier Wars ──────────────────────────────── */
  {
    ...
    transition: { id: 'glitch', duration: 800 },
    content: {
      type: 'comparison',
  ...
  /* ── Slide 9: Apple Sneaks In ───────────────────────────── */
  {
    ...
    transition: { id: 'emoji-telescope', duration: 1000, emoji: '🔭' },
    content: {
      type: 'text',
  ...
  /* ── Slide 10: Unicode Saves the Day ────────────────────── */
  {
    ...
    transition: { id: 'terminal', duration: 900 },
    content: {
      type: 'timeline',
  ...
  /* ── Slide 11: The Explosion ────────────────────────────── */
  {
    ...
    transition: { id: 'emoji-bomb', duration: 1100, emoji: '💥' },
    content: {
      type: 'text',
      title: 'And Then... BOOM',
  ...
  /* ── Slide 12: The Stats ────────────────────────────────── */
  {
    ...
    transition: { id: 'dolly-zoom', duration: 1200 },
    content: {
      type: 'stat',
