...
export const act5Slides: SlideData[] = [
  /* ── Slide 25: Game Reveal ──────────────────────────────── */
  {
    ...
    transition: { id: 'glitch', duration: 1000 },
    content: {
      type: 'game-reveal',
  ...
  /* ── Slide 26: QR Lobby ─────────────────────────────────── */
  {
    ...
    transition: { id: 'fade-black', duration: 800 },
    content: {
      type: 'qr-lobby',
      roomCode: '',
    },
  ...
  /* ── Round 1: Movies ────────────────────────────────────── */
  {
    ...
    transition: { id: 'emoji-clapper', duration: 900, emoji: '🎬' },
    content: {
      type: 'title',
  ...
  /* ── Round 2: TV Shows ──────────────────────────────────── */
  {
    ...
    transition: { id: 'emoji-tv', duration: 900, emoji: '📺' },
    content: {
      type: 'title',
  ...
  /* ── Round 3: Countries ─────────────────────────────────── */
  {
    ...
    transition: { id: 'emoji-portal', duration: 900, emoji: '🌍' },
    content: {
      type: 'title',
  ...
  /* ── Round 4: Sayings ───────────────────────────────────── */
  {
    ...
    transition: { id: 'emoji-magic', duration: 900, emoji: '✨' },
    content: {
      type: 'title',
  ...
  /* ── Slide 35: Final Scoreboard ─────────────────────────── */
  {
    ...
    transition: { id: 'spiral-zoom', duration: 1200 },
    content: {
  ...
  /* ── Slide 36: Thanks / GG ─────────────────────────────── */
  {
    ...
    transition: { id: 'split-confetti', duration: 1000 },
    content: {
      type: 'title',
      title: 'GG',
