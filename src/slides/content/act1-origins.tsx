...
export const act1Slides: SlideData[] = [
  ...
  /* ── Slide 4: Original 176 ───────────────────────────────── */
  {
    ...
    content: {
      type: 'grid',
      retro: true,
      subtitle: 'Simulación del set de Kurita (12x12 pixeles, paleta limitada de colores). La caquita NO estaba — esa llegó después.',
      ...
      items: [
        ...
        { emoji: '💀', label: 'Calavera' }, { emoji: '😴', label: 'Dormir' },
